						...
						return (
							...
							(h.prototype._slide = function(e, n){
								var i = this,
									...
									c = void 0;
								if (
									(e === p.NEXT ? ((l = E.LEFT), (h = E.NEXT), (c = p.LEFT)) : ((l = E.RIGHT), (h = E.PREV), (c = p.RIGHT)),
							...
							(l.prototype.show = function(){
								...
								if (!t(this._element).hasClass(g.SHOW)) {
									var n = void 0,
										i = void 0;
									if (
										(this._parent && ((n = t.makeArray(t(this._parent).find(m.ACTIVES))), n.length || (n = null)),
								...
								if (!n || n.which !== f) {
									...
									for (var o = t.makeArray(t(p.DATA_TOGGLE)), r = 0; r < o.length; r++) {
										...
										if (
											...
											!(
												n &&
												(('click' === n.type && /input|textarea/i.test(n.target.tagName)) || 'focusin' === n.type) &&
									...
									if (
										...
										t(this._element).on(p.CLICK_DISMISS, function(t){
											return n._ignoreBackdropClick
												...
												: void (t.target === t.currentTarget && ('static' === n._config.backdrop ? n._element.focus() : n.hide()));
										}),
					...
					I = (function(){
						...
						return (
							...
							(h.prototype.show = function(){
								...
								if (this.isWithContent() && this._isEnabled) {
									...
									if (r.supportsTransitionEnd() && t(this.tip).hasClass(m.FADE))
										return (
											(this._isTransitioning = !0), void t(this.tip).one(r.TRANSITION_END, d).emulateTransitionEnd(h._TRANSITION_DURATION)
										);
									d();
								}
							}),
							...
							(h.prototype.setElementContent = function(e, n){
								...
								'object' === ('undefined' == typeof n ? 'undefined' : i(n)) && (n.nodeType || n.jquery)
									? o ? t(n).parent().is(e) || e.empty().append(n) : e.text(t(n).text())
									: e[o ? 'html' : 'text'](n);
							}),
