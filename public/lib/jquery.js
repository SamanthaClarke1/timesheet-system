	...
	r.extend({
		...
		r.extend({
			queue: function(a, b, c){
				...
				if (a)
					return (
						(b = (b || 'fx') + 'queue'), (d = V.get(a, b)), c && (!d || r.isArray(c) ? (d = V.access(a, b, r.makeArray(c))) : d.push(c)), d || []
					);
			},
	...
	function hb(a, b, c){
		var d,
			...
			i = function(){
				if (e) return !1;
				for (
					var b = Za || cb(), c = Math.max(0, j.startTime + j.duration - b), d = c / j.duration || 0, f = 1 - d, g = 0, i = j.tweens.length;
					g < i;
					g++
				)
					j.tweens[g].run(f);
				...
				if (3 !== f && 8 !== f && 2 !== f)
					return 'undefined' == typeof a.getAttribute
						...
						: ((1 === f && r.isXMLDoc(a)) || (e = r.attrHooks[b.toLowerCase()] || (r.expr.match.bool.test(b) ? ib : void 0)),
							void 0 !== c
								? null === c ? void r.removeAttr(a, b) : e && 'set' in e && void 0 !== (d = e.set(a, c, b)) ? d : (a.setAttribute(b, c + ''), c)
								: e && 'get' in e && null !== (d = e.get(a, b)) ? d : ((d = r.find.attr(a, b)), null == d ? void 0 : d));
			},
			attrHooks: {
				type: {
					set: function(a, b){
