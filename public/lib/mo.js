...
!(function(t, e){
	'object' == typeof exports && 'object' == typeof module
		? (module.exports = e())
		: 'function' == typeof define && define.amd ? define(e) : 'object' == typeof exports ? (exports.mojs = e()) : (t.mojs = e());
})(this, function(){
	return (function(t){
		function e(i){
					...
					return (
						...
						(e.prototype._isPropChanged = function(t){
							return (
								...
								this._lastSet[t].value !== this._props[t] ? ((this._lastSet[t].value = this._props[t]), !0) : !1
							);
						}),
				...
				T = (function(t){
					...
					return (
						...
						(e.prototype.then = function(e){
							...
							return (
								r.deltas.refresh(!1), (this._history[this._history.length - 1] = r._o), t.prototype.then.call(this, e), r.deltas.restore(), this
							);
						}),
						(e.prototype._checkStartValue = function(t, e){
							return null == e
								? null != this._defaults[t]
									? this._defaults[t]
									: null != this._customProps[t] ? this._customProps[t] : null != w.defaultStyles[t] ? w.defaultStyles[t] : 0
								: e;
						}),
						(e.prototype._draw = function(){
							...
							for (var e = f['default'](t), r = 0; r < e.length; r++) {
								...
								w.isDelta(t[i]) || x[i]
									...
									: (this._parseOption(i, t[i]),
										'el' === i && ((this._props.el = w.parseEl(t.el)), (this.el = this._props.el)),
						...
						(e.prototype._addDefaults = function(t){
							...
							for (var e in this._defaults)
								null == t[e]
									? (t[e] = 'scaleX' === e || 'scaleY' === e ? (null != t.scale ? t.scale : this._defaults.scale) : this._defaults[e])
							...
							return f['default'].isArray(r)
								...
								: r + '' == '[object NodeList]'
									...
									: r + '' == '[object HTMLCollection]'
										...
										: r instanceof HTMLElement ? 1 : 'string' == typeof r ? 1 : void 0;
						}),
					...
					return (
						...
						(e.prototype.play = function(){
							...
							return 'play' === this._state && this._isRunning
								? this
								: ((this._props.isReversed = !1), this._subPlay(t, 'play'), this._setPlaybackState('play'), this);
						}),
						(e.prototype.playBackward = function(){
							var t = arguments.length <= 0 || void 0 === arguments[0] ? 0 : arguments[0];
							return 'reverse' === this._state && this._isRunning
								? this
								: ((this._props.isReversed = !0), this._subPlay(t, 'reverse'), this._setPlaybackState('reverse'), this);
						}),
						(e.prototype.pause = function(){
							return 'pause' === this._state || 'stop' === this._state
								? this
								: (this._removeFromTweener(), this._setPlaybackState('pause'), this);
						}),
						...
						(e.prototype._subPlay = function(){
							...
							return (
								(this._progressTime = this._progressTime >= r.repeatTime ? 0 : this._progressTime),
						...
						(e.prototype._setResumeTime = function(t){
							...
							this._setStartTime(r, !1),
								null != this._prevTime &&
									(this._prevTime = 'play' === t ? this._normPrevTimeForward() : this._props.endTime - this._progressTime);
						}),
						...
						(e.prototype._extendDefaults = function(){
							...
							(e.easing = d['default'].parseEasing(e.easing)),
								...
								null != e.backwardEasing &&
									((e.backwardEasing = d['default'].parseEasing(e.backwardEasing)), (e.backwardEasing._parent = this));
						}),
						...
						(e.prototype._update = function(t, e, r, i){
							...
							null == this._prevTime &&
								null != e &&
								(this._props.speed && this._playTime && (this._prevTime = this._playTime + this._props.speed * (e - this._playTime)),
								(this._wasUknownUpdate = !0));
							var n = s.startTime - s.delay;
							if (
								(s.speed && this._playTime && (t = this._playTime + s.speed * (t - this._playTime)),
									...
									: -1 === i &&
										(r
											...
											: this._prevTime >= s.startTime &&
												...
												((this._prevTime = t + 1), this._repeatStart(t, a), this._start(t, a), (this._isCompleted = !0))),
									(this._prevTime = void 0);
							}
							return (
								t > n && t < s.endTime
									? (this._progressTime = t - n)
									: n >= t ? (this._progressTime = 0) : t >= s.endTime && (this._progressTime = s.repeatTime + 1e-11),
							...
							if (((this._isCompleted = !1), (this._isRefreshed = !1), i + s >= e.startTime)) {
								...
								if (
									...
									this._wasUknownUpdate &&
										...
										t < this._prevTime &&
											(this._complete(t, l), this._repeatComplete(t, l), this._firstUpdate(t, l), (this._isCompleted = !1))),
									_)
								) {
									if (1 !== this.progress) {
								...
								t > this._prevTime &&
									(!this._isStarted &&
										...
										(this._start(t, l), this._repeatStart(t, l), (this._isStarted = !1), (this._isRepeatStart = !1)),
						...
						(e.prototype._setProgress = function(t, e, r){
							...
							return (
								(i.prevEasedProgress !== this.easedProgress || s) &&
									...
									i.onUpdate.call(i.callbacksContext || this, this.easedProgress, this.progress, n, r),
						...
						(e.prototype._complete = function(t, e){
							if (!this._isCompleted) {
								...
								null != r.onComplete &&
									...
									r.onComplete.call(r.callbacksContext || this, t > this._prevTime, e),
									(this._isCompleted = !0),
									(this._isStarted = !1),
									(this._isFirstUpdate = !1),
									(this._prevYoyo = void 0);
						...
						(e.prototype._firstUpdate = function(t, e){
							if (!this._isFirstUpdate) {
								...
								null != r.onFirstUpdate &&
									...
									((r.onFirstUpdate.tween = this), r.onFirstUpdate.call(r.callbacksContext || this, t > this._prevTime, e)),
						...
						(e.prototype._repeatComplete = function(t, e){
							if (!this._isRepeatCompleted) {
								...
								null != r.onRepeatComplete &&
									...
									r.onRepeatComplete.call(r.callbacksContext || this, t > this._prevTime, e),
						...
						(e.prototype._repeatStart = function(t, e){
							if (!this._isRepeatStart) {
								...
								null != r.onRepeatStart &&
									...
									r.onRepeatStart.call(r.callbacksContext || this, t > this._prevTime, e),
						...
						(t.prototype._loop = function(){
							return this._isRunning
								? (this._update(window.performance.now()),
									this.tweens.length ? (requestAnimationFrame(this._loop), this) : (this._isRunning = !1))
								: !1;
						}),
								...
								: 'undefined' != typeof document.mozHidden
									...
									: 'undefined' != typeof document.msHidden
										...
										: 'undefined' != typeof document.webkitHidden &&
											((this._visibilityHidden = 'webkitHidden'), (this._visibilityChange = 'webkitvisibilitychange')),
					...
					return (
						...
						(e.prototype._mergeStartLoop = function(t, e){
							for (var r in e) {
								var i = e[r];
								null != e[r] &&
									((_['default'].isTweenProp(r) && 'duration' !== r) || (t[r] = this._isDelta(i) ? _['default'].getDeltaEnd(i) : i));
							}
						}),
						...
						(e.prototype._mergeThenProperty = function(t, e, r){
							...
							if ((_['default'].isObject(r) && null != r.to && ((i = r.curve), (s = r.easing), (r = r.to)), this._isDelta(r)))
				...
				y = (function(t){
					...
					return (
						...
						(e.prototype._isRewriteNext = function(t, e){
							...
							return (
								s && i
									? f['default'].getDeltaEnd(t) == f['default'].getDeltaStart(e) && (o = !0)
					...
					return (
						...
						(t.prototype._parseDeltaByGuess = function(t, e, r){
							...
							return !isNaN(parseFloat(s)) || s.match(/rand\(/) || s.match(/stagger\(/)
								? n.arrayPropertyMap && n.arrayPropertyMap[t]
									...
									: n.numberPropertyMap && n.numberPropertyMap[t] ? this._parseNumberDelta(t, e, r) : this._parseUnitDelta(t, e, r)
						...
						(t.prototype._makeColorObj = function(t){
							...
							if ('#' !== t[0]) {
								var o = 'r' === t[0] && 'g' === t[1] && 'b' === t[2],
									a = void 0;
								o && (a = t),
									o || (this._shortColors[t] ? (a = this._shortColors[t]) : ((m.div.style.color = t), (a = m.computedStyle(m.div).color)));
						...
						(t.prototype._strToArr = function(t){
							...
							return 'number' != typeof t || isNaN(t)
								? (t.trim().split(/\s+/gim).forEach(function(t){
				...
				l = (function(){
					...
					return (
						...
						(t.prototype._hide = function(){
							this.el &&
								(this._props.isSoftHide ? u['default'].setPrefixedStyle(this.el, 'transform', 'scale(0)') : (this.el.style.display = 'none'),
								(this._isShown = !1));
						}),
						(t.prototype._showByTransform = function(){}),
						(t.prototype._parseOptionString = function(t){
							return (
								'string' == typeof t && t.match(/stagger/) && (t = u['default'].parseStagger(t, this._index)),
		...
		function(t, e, r){
			...
			e['default'] =
				'function' == typeof p['default'] && 'symbol' === s(o['default'])
					...
					: function(t){
							return t && 'function' == typeof p['default'] && t.constructor === p['default']
								? 'symbol'
				...
				return (
					...
					(t.prototype.normDashArrays = function(t, e){
						...
						if (((r = t.length), (i = e.length), r > i))
							for (p = r - i, h = e.length, n = o = 0, u = p; u >= 0 ? u > o : o > u; n = u >= 0 ? ++o : --o)
								(s = n + h), e.push(this.parseUnit('0' + t[s].unit));
						else if (i > r)
							for (p = i - r, h = t.length, n = a = 0, l = p; l >= 0 ? l > a : a > l; n = l >= 0 ? ++a : --a)
								...
								this.callbacksMap[t] ||
									...
									(this.unitOptionMap[t]
										...
										: ((o = parseFloat(this.parseStringOption(o, r))),
											...
											(s = {type: 'number', name: t, start: c, end: o, delta: o - c, easing: n, curve: i})));
						else {
							if ('strokeLinecap' === t)
								return this.warn('Sorry, stroke-linecap property is not animatable yet, using the start(' + c + ') value instead', e), s;
							...
							: e.isStrict && !t.isStrict
								...
								: e.isStrict && t.isStrict && e.unit !== t.unit
									? ((t.unit = e.unit),
										...
										this.warn(
											'Two different units were specified on "' + r + '" delta property, mo · js will fallback to end "' + e.unit + '" unit '
										))
									: void 0;
					}),
					...
					(t.prototype.parsePath = function(t){
						...
						return 'string' == typeof t
							? 'm' === t.charAt(0).toLowerCase()
								? ((e = document.createElementNS(this.NS, 'path')), e.setAttributeNS(null, 'd', t), e)
					...
					(t.prototype.parseEl = function(t){
						return s.isDOM(t)
							? t
							: ('string' == typeof t && (t = document.querySelector(t)), null === t && s.error("Can't parse HTML element: ", t), t);
					}),
				...
				(s = (function(){
					...
					return (
						...
						(t.prototype.getShape = function(t){
							return (
								this[t] ||
								d.error('no "' + t + '" shape available yet, please choose from this list:', [
									'circle',
									'line',
									'zigzag',
									'rect',
				...
				(i = (function(){
					...
					return (
											...
											? ((this.len = this.path.getTotalLength()),
												...
												null != this.container)
													? (this.removeEvent(this.container, 'onresize', this.getScaler),
														this.addEvent(this.container, 'onresize', this.getScaler))
													: void 0)
						...
						(t.prototype.parseEl = function(t){
							return 'string' == typeof t
								? document.querySelector(t)
								: t instanceof HTMLElement ? t : null != t._setProp ? ((this.isModule = !0), t) : void 0;
						}),
						...
						(t.prototype.getScaler = function(){
							var t, e, r;
							switch (((this.cSize = {width: this.container.offsetWidth || 0, height: this.container.offsetHeight || 0}),
								...
								for (r in t)
									(i = t[r]),
										o.callbacksMap[r] || o.tweenOptionMap[r]
											? (o.warn('the property "' + r + '" property can not be overridden on run yet'), delete t[r])
											: (this.history[0][r] = i);
								this.tuneOptions(t);
							}
								...
								(this.tween = new n({
									...
									onComplete: (function(t){
										return function(){
											var e;
											return (
												t.props.motionBlur && t.setBlur({blur: {x: 0, y: 0}, offset: {x: 0, y: 0}}),
								...
								this.props.isAngle || null != this.props.angleOffset || s
									? ((n = this.path.getPointAtLength(e - 1)),
										...
										'function' != typeof this.props.angleOffset
											...
											: (this.angle = this.props.angleOffset.call(this, this.angle, r)))
									: (this.angle = 0)
							);
						}),
						(t.prototype._setTransform = function(t, e, r, i){
							...
							return (
								...
								this.isModule
									...
									: 'string' != typeof s ? this.setElPosition(t, e, r) : o.setPrefixedStyle(this.el, 'transform', s)
							);
						}),
						...
						(t.prototype.setBlur = function(t){
							return this.isMotionBlurReset
								? void 0
								: (this.filter.setAttribute('stdDeviation', t.blur.x + ',' + t.blur.y),
						...
						(t.prototype.then = function(t){
							...
							for (r in s)
								(a = s[r]),
									(!o.callbacksMap[r] && !o.tweenOptionMap[r]) || 'duration' === r
										? null == t[r] && (t[r] = a)
										: null == t[r] && (t[r] = void 0),
						...
						(t.prototype.elastic = {
							in: function(t){
								...
								return (
									(i = void 0),
									(r = 0.4),
									0 === t ? 0 : 1 === t ? 1 : ((e = 1), (i = r / 4), -(e * Math.pow(2, 10 * (t -= 1)) * Math.sin(2 * (t - i) * Math.PI / r)))
								);
							},
							out: function(t){
								var e, r, i;
								return (
									(i = void 0),
									(r = 0.4),
									0 === t ? 0 : 1 === t ? 1 : ((e = 1), (i = r / 4), e * Math.pow(2, -10 * t) * Math.sin(2 * (t - i) * Math.PI / r) + 1)
								);
							},
							inout: function(t){
								var e, r, i;
									...
									0 === t
										...
										: 1 === t
											...
											: ((e = 1),
												(i = r / 4),
												(t *= 2) < 1
													? -0.5 * e * Math.pow(2, 10 * (t -= 1)) * Math.sin(2 * (t - i) * Math.PI / r)
													: e * Math.pow(2, -10 * (t -= 1)) * Math.sin(2 * (t - i) * Math.PI / r) * 0.5 + 1)
								);
							},
						}),
						(t.prototype.bounce = {
							...
							out: function(t){
								return 1 / 2.75 > t
									...
									: 2 / 2.75 > t
										...
										: 2.5 / 2.75 > t ? 7.5625 * (t -= 2.25 / 2.75) * t + 0.9375 : 7.5625 * (t -= 2.625 / 2.75) * t + 0.984375;
							},
							inout: function(t){
								...
								'string' === r
									? 'm' === t.charAt(0).toLowerCase()
										...
										: ((t = this._splitEasing(t)),
											...
											e
												? e[t[1]]
												: (u.error('Easing with name "' + t[0] + '" was not found, fallback to "linear.none" instead'), this.linear.none))
									: u.isArray(t) ? this.bezier.apply(this, t) : t
							);
						}),
						(t.prototype._splitEasing = function(t){
							...
							return 'function' == typeof t
								...
								: 'string' == typeof t && t.length
									? ((i = t.split('.')), (e = i[0].toLowerCase() || 'linear'), (r = i[1].toLowerCase() || 'none'), [ e, r ])
									: [ 'linear', 'none' ];
						}),
						t
					);
		...
		function(t, e, r){
			...
			e['default'] = function(t, e){
				...
				(t.prototype = a['default'](e && e.prototype, {constructor: {value: t, enumerable: !1, writable: !0, configurable: !0}})),
			...
			var s = r(18),
				...
				y = (function(t){
					...
					return (
						...
						(e.prototype._render = function(){
							this._isRendered ||
								((this._isRendered = !0), this._createSVGCanvas(), this._setCanvasSize(), this._props.parent.appendChild(this._canvas));
						}),
						...
						(e.prototype.castStrokeDash = function(t){
							...
							'object' === n['default'](e[t]) &&
								((r = '%' === e[t].unit ? this.castPercent(e[t].value) : e[t].value), (e[t] = 0 === r ? (r = '') : r));
						}),
			...
			!(function(t){
				...
				return (
					...
					null == t.performance.now
						? ((e = (null != (r = t.performance) && null != (i = r.timing) ? i.navigationStart : void 0)
						...
						return (
																		...
																		(i = function(){
																			...
																			return (
																				(this !== window || this !== document) &&
																					((t = 'onresize' === arguments[0] && !this.isAnyResizeEventInited),
																					t && e.handleResize({args: arguments, that: this})),
																				r.apply(this, arguments)
																			);
																		}),
																		t.prototype.addEventListener
																			? (t.prototype.addEventListener = i)
																			: t.prototype.attachEvent ? (t.prototype.attachEvent = i) : void 0
																	);
																})(r),
																...
																(function(e){
																	...
																	return (
																		...
																		t.prototype.removeEventListener
																			...
																			: t.prototype.detachEvent ? (t.prototype.detachEvent = wrappedListener) : void 0
																	);
																})(i)
															);
														})(r)
										...
										(function(i){
											return function(){
												...
												return (
													(n = t.offsetWidth),
													(s = t.offsetHeight),
													n !== r || s !== e ? (i.dispatchEvent(t), (r = n), (e = s)) : void 0
												);
											};
										})(this),
							...
							(t.prototype.dispatchEvent = function(t){
								...
								return document.createEvent
									...
									: document.createEventObject ? ((e = document.createEventObject()), t.fireEvent('onresize', e)) : !1;
							}),
					...
					return (
						...
						(e.prototype._draw = function(){
							var e = this._props,
								...
								n = r.radius !== e.radius;
							(i || s || n) &&
								(this.el.setAttribute('transform', this._getScale()), (r.radiusX = e.radiusX), (r.radiusY = e.radiusY), (r.radius = e.radius)),
					...
					(i = (function(){
						...
						return (
							...
							(t.prototype.generate = function(t, r, i, s){
								...
								for (S = P = 0; 4 > P; S = ++P)
									if (((d = arguments[S]), 'number' != typeof d || isNaN(d) || !isFinite(d)))
				...
				(i = (function(){
					...
					return (
						...
						(t.prototype._preSample = function(){
							...
							for (this._samples = [], o = [], t = e = 0, n = this._precompute; n >= 0 ? n >= e : e >= n; t = n >= 0 ? ++e : --e)
								(s = t * this._step),
									(r = this.pathLength * s),
									(i = this.path.getPointAtLength(r)),
									o.push((this._samples[t] = {point: i, length: r, progress: s}));
							return o;
						}),
						...
						(t.prototype._findApproximate = function(t, e, r, i){
							...
							return (
								...
								s.closeEnough(t, u, this._eps)
									...
									: --i < 1
										? this._resolveY(p)
										: ((a = {point: p, length: n}), (o = u > t ? [ t, e, a, i ] : [ t, a, r, i ]), this._findApproximate.apply(this, o))
							);
						}),
						...
						(t.prototype._getSegmentPairs = function(t){
							var e, r, i, n, o, a;
							for (
								t.length % 2 !== 0 && s.error('Failed to parse the path - segment pairs are not even.', t), n = [], e = r = 0, i = t.length;
								i > r;
								e = r += 2
							)
				...
				(o = function(){
					...
					return (
						...
						function(e){
							var r, i;
							return (
								(r = n(t, e)), -1 !== r ? ((i = t[r].value), r === t.length - 1 && e > t[r].to ? 1 : 'function' == typeof i ? i(e) : i) : void 0
							);
						}
					);
				}),
		...
		function(t, e, r){
			...
			var i = r(66),
				...
				j = function(t, e, r){
					return r && n(A, e)
						? (r.enumerable
								? (n(t, D) && t[D][e] && (t[D][e] = !1), (r = P(r, {enumerable: w(0, !1)})))
			...
			i.each.call('hasInstance,isConcatSpreadable,iterator,match,replace,search,species,split,toPrimitive,toStringTag,unscopables'.split(','), function(
				t
			){
				var e = f(t);
				W[t] = L ? e : F(e);
			...
			t.exports = function(t){
				return function(e, r){
					...
					return 0 > p || p >= u
						? t ? '' : void 0
						: ((n = a.charCodeAt(p)),
							55296 > n || n > 56319 || p + 1 === u || (o = a.charCodeAt(p + 1)) < 56320 || o > 57343
								? t ? a.charAt(p) : n
								: t ? a.slice(p, p + 2) : ((n - 55296) << 10) + (o - 56320) + 65536);
				};
			};
		},
		function(t, e, r){
									...
									c && 'function' != typeof g[p]
										...
										: _ && u
											...
											: y && g[p] == l
												...
												: d && 'function' == typeof l ? n(Function.call, l) : l),
								d && ((m[o] || (m[o] = {}))[p] = l));
				};
		...
		function(t, e, r){
			...
			t.exports = function(t){
				...
				return void 0 === t
					...
					: null === t
						? 'Null'
						: 'string' == typeof (r = (e = Object(t))[s]) ? r : n ? i(e) : 'Object' == (o = i(e)) && 'function' == typeof e.callee ? 'Arguments' : o;
			};
		},
		function(t, e, r){
			var i = r(106);
