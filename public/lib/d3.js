...
(function(t, n){
	...
	function o(t, n){
		var e,
			...
			f = 0,
			c = 0;
		if (null == n) for (; ++u < o; ) isNaN((e = i(t[u]))) || (c += (r = e - f) * (e - (f += r / ++a)));
		else for (; ++u < o; ) isNaN((e = i(n(t[u], u, t)))) || (c += (r = e - f) * (e - (f += r / ++a)));
		if (a > 1) return c / (a - 1);
	}
	function a(t, n){
		var e = o(t, n);
	...
	function T(t, n){
		function e(e){
			...
			(m = m.merge(m.enter().insert('path', '.tick').attr('class', 'domain').attr('stroke', '#000'))),
				...
				(S = S.merge(T.append('text').attr('fill', '#000').attr(s, c * p).attr('dy', t === fs ? '0em' : t === ss ? '0.71em' : '0.32em'))),
				e !== b &&
					((m = m.transition(e)),
					(w = w.transition(e)),
					(N = N.transition(e)),
					(S = S.transition(e)),
					(M = M.transition(e).attr('opacity', hs).attr('transform', function(t){
				...
				M.remove(),
				m.attr('d', t === ls || t == cs ? 'M' + c * u + ',' + g + 'H0.5V' + y + 'H' + c * u : 'M' + g + ',' + c * u + 'V0.5H' + y + 'V' + c * u),
				...
				b
					...
					.attr('text-anchor', t === cs ? 'start' : t === ls ? 'end' : 'middle'),
				b.each(function(){
					this.__axis = _;
				});
		}
	...
	function kt(t){
		...
		return (
			...
			(n = Ss.exec(t))
				? ((n = parseInt(n[1], 16)), new Lt(((n >> 8) & 15) | ((n >> 4) & 240), ((n >> 4) & 15) | (240 & n), ((15 & n) << 4) | (15 & n), 1))
				: (n = Es.exec(t))
					? Ct(parseInt(n[1], 16))
					: (n = ks.exec(t))
								...
								: (n = zs.exec(t))
									...
									: (n = Rs.exec(t))
										...
										: (n = Ls.exec(t))
											...
											: Ds.hasOwnProperty(t) ? Ct(Ds[t]) : 'transparent' === t ? new Lt(NaN, NaN, NaN, 0) : null
		);
	}
	function Ct(t){
	...
	function Bt(t){
		...
		return (
			i === o && o === a
				? (e = r = u)
				: ((e = jt((0.4360747 * i + 0.3850649 * o + 0.1430804 * a) / Os)), (r = jt((0.0139322 * i + 0.0971045 * o + 0.7141733 * a) / Bs))),
	...
	function hn(t, n){
		...
		for (t += '', n += ''; (e = al.exec(t)) && (r = ul.exec(n)); )
			(i = r.index) > o && ((i = n.slice(o, i)), u[a] ? (u[a] += i) : (u[++a] = i)),
				(e = e[0]) === (r = r[0]) ? (u[a] ? (u[a] += r) : (u[++a] = r)) : ((u[++a] = null), f.push({i: a, x: sn(e, r)})),
				(o = ul.lastIndex);
		return (
			...
			: ('number' === r
					...
					: 'string' === r
						...
						: n instanceof kt
							...
							: n instanceof Date
								? cn
								: Array.isArray(n) ? fn : ('function' != typeof n.valueOf && 'function' != typeof n.toString) || isNaN(n) ? ln : sn)(t, n);
	}
	function pn(t, n){
		return (
			(t = +t),
	...
	function vn(t, n, e, r, i, o){
		...
		return (
			...
			{translateX: i, translateY: o, rotate: Math.atan2(n, t) * fl, skewX: Math.atan(f) * fl, scaleX: a, scaleY: u}
		);
	}
	function gn(t, n, e, r){
		function i(t){
		...
		return function(o, a){
			...
			return (
				...
				(function(t, n, e, o){
					t !== n
						? (t - n > 180 ? (n += 360) : n - t > 180 && (t += 360), o.push({i: e.push(i(e) + 'rotate(', null, r) - 2, x: sn(t, n)}))
				...
				(function(){
					...
					for (; e; )
						e._call
							...
							: ((n = e._next), (e._next = null), (e = t ? (t._next = n) : (nl = n)));
					(el = t), kn(r);
				})(),
				(Sl = 0);
		}
	...
	function kn(t){
		if (!wl) {
			...
			t - Sl > 24
				? (t < 1 / 0 && (Ml = setTimeout(Sn, t - kl.now() - El)), Al && (Al = clearInterval(Al)))
				: (Al || ((Nl = kl.now()), (Al = setInterval(En, Tl))), (wl = 1), Cl(Sn));
		}
	}
	function Cn(t, n, e){
		var r = new An();
			...
			function r(f){
				...
				for (c in u)
					if ((h = u[c]).name === e.name) {
						...
						h.state === ql
							? ((h.state = Yl), h.timer.stop(), h.on.call('interrupt', t, t.__data__, h.index, h.group), delete u[c])
				...
				if (
					...
					for (e.state = Ul, a = new Array((l = e.tween.length)), c = 0, s = -1; c < l; ++c)
						(h = e.tween[c].value.call(t, t.__data__, e.index, e.group)) && (a[++s] = h);
					a.length = s + 1;
				}
			}
			function i(n){
				for (var r = n < e.duration ? e.ease.call(null, n / e.duration) : (e.timer.restart(o), (e.state = Ol), 1), i = -1, u = a.length; ++i < u; )
					a[i].call(null, r);
		...
		function a(){
			...
			function o(){
				...
				switch (((y = U[0] - D[0]), (_ = U[1] - D[1]), A)) {
					...
					case vh:
						T < 0
							? ((y = Math.max(C - u, Math.min(z - u, y))), (c = u + y), (p = d))
							: T > 0 && ((y = Math.max(C - d, Math.min(z - d, y))), (c = u), (p = d + y)),
							N < 0
								? ((_ = Math.max(P - l, Math.min(R - l, _))), (h = l + _), (g = v))
								: N > 0 && ((_ = Math.max(P - v, Math.min(R - v, _))), (h = l), (g = v + _));
						break;
					case gh:
				...
				p < c && ((T *= -1), (t = u), (u = d), (d = t), (t = c), (c = p), (p = t), M in xh && Y.attr('cursor', mh[(M = xh[M])])),
					g < h && ((N *= -1), (t = l), (l = v), (v = t), (t = h), (h = g), (g = t), M in wh && Y.attr('cursor', mh[(M = wh[M])])),
			...
			if (s.apply(this, arguments)) {
				...
				'overlay' === M
					? (S.selection = k = [ [ (u = n === _h ? C : D[0]), (l = n === yh ? P : D[1]) ], [ (d = n === _h ? z : u), (v = n === yh ? R : l) ] ])
							...
							function(){
								switch (t.event.keyCode) {
									...
									case 32:
										A === ph &&
											(t.event.altKey
												? (T && ((d = p - y * T), (u = c + y * T)), N && ((v = g - _ * N), (l = h + _ * N)), (A = gh))
												: (T < 0 ? (d = p) : T > 0 && (u = c), N < 0 ? (v = g) : N > 0 && (l = h), (A = vh)),
											Y.attr('cursor', mh[M]),
											o());
										break;
									default:
		...
		function n(t, n){
			...
			return (
				(function(t, n, r){
					function a(t){
						...
						(n = p[c])
							? (i = d[s])
								? (delete p[n.end],
									delete d[i.start],
									n === i ? (n.ring.push(a), r(n.ring)) : (d[n.start] = p[i.end] = {start: n.start, end: i.end, ring: n.ring.concat(i.ring)}))
								: (delete p[n.end], n.ring.push(a), (p[(n.end = s)] = n))
							: (n = d[s])
								? (i = p[c])
									? (delete d[n.start],
										delete p[i.end],
										n === i ? (n.ring.push(a), r(n.ring)) : (d[i.start] = p[n.end] = {start: i.start, end: n.end, ring: i.ring.concat(n.ring)}))
					...
					qh[s << 0].forEach(a);
					for (; ++f < o - 1; ) {
						for (u = -1, s = t[f * i + i] >= n, l = t[f * i] >= n, qh[(s << 1) | (l << 2)].forEach(a); ++u < i - 1; )
							(c = s), (s = t[f * i + i + u + 1] >= n), (h = l), (l = t[f * i + u + 1] >= n), qh[c | (s << 1) | (l << 2) | (h << 3)].forEach(a);
						qh[s | (l << 3)].forEach(a);
					}
		...
		function r(t, n, e){
			t.forEach(function(t){
				var r,
					...
					c = 0 | u,
					s = n[c * i + f];
				a > 0 && a < i && f === a && ((r = n[c * i + f - 1]), (t[0] = a + (e - r) / (s - r) - 0.5)),
					u > 0 && u < o && c === u && ((r = n[(c - 1) * i + f]), (t[1] = u + (e - r) / (s - r) - 0.5));
			});
		}
		var i = 1,
			o = 1,
	...
	function Ae(t, n, e){
		for (var r = t.width, i = t.height, o = 1 + (e << 1), a = 0; a < i; ++a)
			for (var u = 0, f = 0; u < r + e; ++u)
				u < r && (f += t.data[u + a * r]),
					u >= e && (u >= o && (f -= t.data[u - o + a * r]), (n.data[u - e + a * r] = f / Math.min(u + 1, r - 1 + o - u, o)));
	}
	function Te(t, n, e){
		for (var r = t.width, i = t.height, o = 1 + (e << 1), a = 0; a < r; ++a)
			for (var u = 0, f = 0; u < i + e; ++u)
				u < i && (f += t.data[a + u * r]),
					u >= e && (u >= o && (f -= t.data[a + (u - o) * r]), (n.data[a + (u - e) * r] = f / Math.min(u + 1, i - 1 + o - u, o)));
	}
	function Ne(t){
		return t[0];
	}
		...
		function n(t, n){
			function e(){
				...
				if (t.charCodeAt(r) === Bh) {
					...
					return (
						(n = u) >= a ? (c = !0) : (e = t.charCodeAt(u++)) === Fh ? (s = !0) : e === Ih && ((s = !0), t.charCodeAt(u) === Fh && ++u),
	...
	function ir(t){
		function n(t){
			...
			var u = (t = tr(t)).fill,
				...
				v = t.trim,
				g = t.type;
			'n' === g ? ((d = !0), (g = 'g')) : sd[g] || (null == p && (p = 12), (v = !0), (g = 'g')),
				(l || ('0' === u && '=' === f)) && ((l = !0), (u = '0'), (f = '='));
			var y = '$' === s ? r[0] : '#' === s && /[boxX]/.test(g) ? '0' + g.toLowerCase() : '',
				...
				m = /[defgprs%]/.test(g);
			return (
				(p = null == p ? 6 : /[gprs]/.test(g) ? Math.max(1, Math.min(21, p)) : Math.max(0, Math.min(20, p))),
				(n.toString = function(){
					return t + '';
				}),
				n
					...
					? (function(t, n){
							return function(e, r){
								for (
									...
									i > 0 && u > 0 && (f + u + 1 > r && (u = Math.max(1, r - f)), o.push(e.substring((i -= u), i + u)), !((f += u + 1) > r));
	...
	function zr(t, n){
		...
		if (Ad) {
			...
			c ^ (u * xd < f && f < u * t)
				? (o = i[1] * Zd) > md && (md = o)
				: ((f = (f + 360) % 360 - 180), c ^ (u * xd < f && f < u * t) ? (o = -i[1] * Zd) < _d && (_d = o) : (n < _d && (_d = n), n > md && (md = n))),
				c
					? t < xd ? Or(yd, t) > Or(yd, bd) && (bd = t) : Or(t, bd) > Or(yd, bd) && (yd = t)
					: bd >= yd ? (t < yd && (yd = t), t > bd && (bd = t)) : t > xd ? Or(yd, t) > Or(yd, bd) && (bd = t) : Or(t, bd) > Or(yd, bd) && (yd = t);
				...
				m = {
					...
					polygonEnd: function(){
						...
						d.length
							...
							: t && (b || (i.polygonStart(), (b = !0)), i.lineStart(), e(null, null, 1, i), i.lineEnd()),
							b && (i.polygonEnd(), (b = !1)),
							(d = h = null);
					},
					sphere: function(){
	...
	function gi(t){
		...
		function e(t, n, e){
			...
			if (!(g < 0)) {
				...
				if (
					(!T && M < w && ((b = w), (w = M), (M = b)),
					T || A < Hd ? (T ? (w + M > 0) ^ (_[1] < (Jd(_[0] - m) < Hd ? w : M)) : w <= _[1] && _[1] <= M) : (A > Gd) ^ (m <= _[0] && _[0] <= x))
				) {
					var N = kr(d, (-p + y) / v);
			...
			function(t){
				...
				return {
					...
					point: function(l, h){
						...
						if (
							(!i && (c = f = v) && t.lineStart(),
							v !== f && (!(d = e(i, p)) || fi(i, d) || fi(p, d)) && ((p[0] += Hd), (p[1] += Hd), (v = n(p[0], p[1]))),
							v !== f)
						)
			...
			function c(o, a){
				...
				if ((l && h.push([ o, a ]), m)) (d = o), (p = a), (v = u), (m = !1), u && (w.lineStart(), w.point(o, a));
					...
					!(function(t, n, e, r, i, o){
						...
						: (b || (w.lineStart(), w.point(f[0], f[1])), w.point(c[0], c[1]), u || w.lineEnd(), (x = !1));
				}
				(g = o), (_ = a), (b = u);
			}
			var s,
				...
				A = {
					...
					polygonEnd: function(){
						var n = (function(){
							...
							e = x && n,
							i = (s = y(s)).length;
						(e || i) && (a.polygonStart(), e && (a.lineStart(), o(null, null, 1, a), a.lineEnd()), i && si(s, u, n, o, a), a.polygonEnd()),
							(w = a),
							(s = l = h = null);
					},
				};
					...
					function e(r, i, o, a, u, f, c, s, l, h, d, p, v, g){
						...
						if (b > 4 * n && v--) {
							var m = a + h,
								...
								C = E - i,
								P = _ * k - y * C;
							(P * P / b > n || Jd((y * k + _ * C) / b - 0.5) > 0.3 || a * h + u * d + f * p < lv) &&
								(e(r, i, o, a, u, f, S, E, T, (m /= M), (x /= M), w, v, g), g.point(S, E), e(S, E, T, m, x, w, c, s, l, h, d, p, v, g));
						}
					}
					return function(n){
						function r(e, r){
	...
	function uo(t){
		...
		return (
			...
			(n.clipExtent = function(t){
				return arguments.length
					? ((N = null == t ? ((T = a = u = f = null), zi) : yi((T = +t[0][0]), (a = +t[0][1]), (u = +t[1][0]), (f = +t[1][1]))), r())
					: null == T ? null : [ [ T, a ], [ u, f ] ];
			}),
			(n.scale = function(t){
			...
			(n.rotate = function(t){
				return arguments.length
					? ((b = (t[0] % 360) * Qd), (m = (t[1] % 360) * Qd), (x = t.length > 2 ? (t[2] % 360) * Qd : 0), e())
					: [ b * Zd, m * Zd, x * Zd ];
			}),
			(n.angle = function(t){
	...
	function go(t){
		function n(){
			...
			return c(
				null == s
					...
					: t === vo ? [ [ Math.max(a[0] - n, s), e ], [ Math.min(a[0] + n, r), i ] ] : [ [ s, Math.max(a[1] - n, e) ], [ r, Math.min(a[1] + n, i) ] ]
			);
		}
		var e,
			r,
		...
		return (
			...
			(o.clipExtent = function(t){
				return arguments.length
					? (null == t ? (s = e = r = i = null) : ((s = +t[0][0]), (e = +t[0][1]), (r = +t[1][0]), (i = +t[1][1])), n())
					: null == s ? null : [ [ s, e ], [ r, i ] ];
			}),
			n()
		);
							...
							(o = (function(t, n){
								...
								for (e = 0; e < t.length - 1; ++e)
									for (r = e + 1; r < t.length; ++r)
										if (qo(Bo(t[e], t[r]), n) && qo(Bo(t[e], n), t[r]) && qo(Bo(t[r], n), t[e]) && Yo(Fo(t[e], t[r], n), t))
											return [ t[e], t[r], n ];
								throw new Error();
							})(o, n))
						)),
	...
	function Io(t, n, e){
		...
		c
			? ((i = n.r + e.r),
				...
				(a = t.r + e.r),
				i > (a *= a)
					? ((r = (c + a - i) / (2 * c)), (o = Math.sqrt(Math.max(0, a / c - r * r))), (e.x = t.x - r * u - o * f), (e.y = t.y - r * f + o * u))
					: ((r = (c + i - a) / (2 * c)), (o = Math.sqrt(Math.max(0, i / c - r * r))), (e.x = n.x + r * u - o * f), (e.y = n.y + r * f + o * u)))
			: ((e.x = n.x + e.r), (e.y = n.y));
	}
	function jo(t, n){
		var e = t.r + n.r - 1e-6,
	...
	function la(t, n, e, r, i, o){
		for (var a, u, f, c, s, l, h, d, p, v, g, y = [], _ = n.children, b = 0, m = 0, x = _.length, w = n.value; b < x; ) {
			...
			y.push((a = {value: s, dice: f < c, children: _.slice(b, m)})),
				a.dice ? na(a, e, r, i, w ? (r += c * s / w) : o) : sa(a, e, r, w ? (e += f * s / w) : i, o),
				(w -= s),
				(b = m);
		}
		return y;
		...
		return (
			...
			(n.nice = function(t){
				...
				return (
					...
					(r = h(u, f, t)) > 0
						? (r = h((u = Math.floor(u / r) * r), (f = Math.ceil(f / r) * r), t))
						: r < 0 && (r = h((u = Math.ceil(u * r) / r), (f = Math.floor(f * r) / r), t)),
					r > 0
		...
		function n(t, n){
			return function(e){
				...
				for (e instanceof Date || (e = new Date(+e)); ++u < c; )
					37 === t.charCodeAt(u) &&
						(a.push(t.slice(f, u)),
						null != (i = Ug[(r = t.charAt(++u))]) ? (r = t.charAt(++u)) : (i = 'e' === r ? ' ' : '0'),
						(o = n[r]) && (r = o(e, i)),
						a.push(r),
						(f = u + 1));
		...
		function e(t, n){
			return function(e){
				...
				if (('p' in a && (a.H = a.H % 12 + 12 * a.p), 'V' in a)) {
					...
					'w' in a || (a.w = 1),
						'Z' in a
							? ((i = (o = (i = Ga(Va(a.y))).getUTCDay()) > 4 || 0 === o ? _g.ceil(i) : _g(i)),
								(i = vg.offset(i, 7 * (a.V - 1))),
								(a.y = i.getUTCFullYear()),
								(a.m = i.getUTCMonth()),
								(a.d = i.getUTCDate() + (a.w + 6) % 7))
							: ((i = (o = (i = n(Va(a.y))).getDay()) > 4 || 0 === o ? $v.ceil(i) : $v(i)),
	...
	function of(t, n, r, i, o, a, u, f, c){
		...
		function l(n, r, i, o){
			if ((null == n && (n = 10), 'number' == typeof n)) {
				...
				u === A.length
					? ((o = d(r / Wg, i / Wg, n)), (n = t))
					: u ? ((o = (u = A[a / A[u - 1][2] < A[u][2] / a ? u - 1 : u])[1]), (n = u[0])) : ((o = Math.max(d(r, i, n), 1)), (n = f));
			}
	...
	function uf(t){
		...
		return (
			(n.domain = function(t){
				return arguments.length
					? ((e = +t[0]), (r = +t[1]), (i = +t[2]), (o = e === r ? 0 : 0.5 / (r - e)), (a = r === i ? 0 : 0.5 / (i - r)), n)
					: [ e, r, i ];
			}),
			(n.clamp = function(t){
				return arguments.length ? ((u = !!t), n) : u;
	...
	function Df(t){
		function n(){
			var n,
				...
				f = e.apply(this, u),
				c = r.apply(this, u);
			if ((a || (a = n = oe()), t(a, +i.apply(this, ((u[0] = f), u)), +o.apply(this, u), +i.apply(this, ((u[0] = c), u)), +o.apply(this, u)), n))
	...
	function nc(t, n, e){
		var r = t._x1 - t._x0,
			...
			a = (e - t._y1) / (i || (r < 0 && -0)),
			u = (o * i + a * r) / (r + i);
		return (tc(o) + tc(a)) * Math.min(Math.abs(o), Math.abs(a), 0.5 * Math.abs(u)) || 0;
	}
	function ec(t, n){
		var e = t._x1 - t._x0;
	...
	function Bc(t, n){
		...
		for (rb = [], nb = new Array(t.length), tb = new _c(), eb = new _c(); ; )
			if (((i = K_), o && (!i || o[1] < i.y || (o[1] === i.y && o[0] < i.x))))
				(o[0] === e && o[1] === r) || (Uc(o), (e = o[0]), (r = o[1])), (o = t.pop());
			else {
				if (!i) break;
				Dc(i.arc);
			}
		if (
			...
			(function(t, n, e, r){
				for (var i, o = rb.length; o--; )
					(Sc((i = rb[o]), t, n, e, r) && Nc(i, t, n, e, r) && (Math.abs(i[0][0] - i[1][0]) > ab || Math.abs(i[0][1] - i[1][1]) > ab)) ||
						delete rb[o];
			})(a, u, f, c),
				(function(t, n, e, r){
					var i,
													...
													Math.abs(p - t) < ab && r - v > ab
														...
														: Math.abs(v - r) < ab && e - p > ab
															...
															: Math.abs(p - e) < ab && v - n > ab
																...
																: Math.abs(v - n) < ab && p - t > ab ? [ Math.abs(h - n) < ab ? l : t, n ] : null
												)
											) - 1
										),
										++c);
		...
		on: function(t, n, e){
			...
			if (u)
				for (var f, c = 0, s = u.length; c < s; ++c)
					for (r = 0, f = u[c]; r < a; ++r) if ((i = o[r]).type === f.type && i.name === f.name) return f.value;
		},
	...
	Nt(Et, kt, {
		...
		Nt(
			...
			St(Et, {
				brighter: function(t){
					return (t = null == t ? 1 / 0.7 : Math.pow(1 / 0.7, t)), new Lt(this.r * t, this.g * t, this.b * t, this.opacity);
				},
				darker: function(t){
					return (t = null == t ? 0.7 : Math.pow(0.7, t)), new Lt(this.r * t, this.g * t, this.b * t, this.opacity);
				},
				rgb: function(){
					return this;
				},
		...
		Nt(
			...
			St(Et, {
				brighter: function(t){
					return (t = null == t ? 1 / 0.7 : Math.pow(1 / 0.7, t)), new Ot(this.h, this.s, this.l * t, this.opacity);
				},
				darker: function(t){
					return (t = null == t ? 0.7 : Math.pow(0.7, t)), new Ot(this.h, this.s, this.l * t, this.opacity);
				},
				rgb: function(){
		...
		St(Et, {
			...
			rgb: function(){
				var t = isNaN(this.h) ? 0 : (this.h + 120) * Us,
					...
					r = Math.cos(t),
					i = Math.sin(t);
				return new Lt(255 * (n + e * (-0.14861 * r + 1.78277 * i)), 255 * (n + e * (Xs * r + Gs * i)), 255 * (n + e * (Vs * r)), this.opacity);
			},
		})
	);
	var Qs,
		...
		sl = gn(
			function(t){
				return 'none' === t
					? cl
					: (Qs || ((Qs = document.createElement('DIV')), (Js = document.documentElement), (Ks = document.defaultView)),
						(Qs.style.transform = t),
						(t = Ks.getComputedStyle(Js.appendChild(Qs), null).getPropertyValue('transform')),
						Js.removeChild(Qs),
						(t = t.slice(7, -1).split(',')),
		...
		ll = gn(
			function(t){
				return null == t
					? cl
					: (tl || (tl = document.createElementNS('http://www.w3.org/2000/svg', 'g')),
						tl.setAttribute('transform', t),
						(t = tl.transform.baseVal.consolidate()) ? ((t = t.matrix), vn(t.a, t.b, t.c, t.d, t.e, t.f)) : cl);
			},
			', ',
			')',
			')'
	...
	An.prototype = Tn.prototype = {
		...
		restart: function(t, n, e){
			...
			(e = (null == e ? wn() : +e) + (null == n ? 0 : +n)),
				this._next || el === this || (el ? (el._next = this) : (nl = this), (el = this)),
				(this._call = t),
				(this._time = e),
				kn();
		},
			...
			for (var r = this._groups, i = r.length, o = new Array(i), a = 0; a < i; ++a)
				for (var u, f, c = r[a], s = c.length, l = (o[a] = new Array(s)), h = 0; h < s; ++h)
					(u = c[h]) &&
						...
						('__data__' in u && (f.__data__ = u.__data__), (l[h] = f), Pn(l[h], n, e, h, l, Ln(u, e)));
							...
							? (function(t, n, e){
									...
									return function(){
										var a = F(this, t),
											u = e(this);
										return (
											null == u && (this.style.removeProperty(t), (u = F(this, t))),
			...
			for (v && p.push(new Be(v, s, l, h, d)), null == e ? (e = 1 / 0) : ((s = t - e), (l = n - e), (h = t + e), (d = n + e), (e *= e)); (f = p.pop()); )
				if (!(!(v = f.node) || (i = f.x0) > h || (o = f.y0) > d || (a = f.x1) < s || (u = f.y1) < l))
					if (v.length) {
						var g = (i + a) / 2,
							y = (o + u) / 2;
						p.push(new Be(v[3], g, y, a, u), new Be(v[2], i, y, g, u), new Be(v[1], g, o, a, y), new Be(v[0], i, o, g, y)),
			...
			s: function(t, n){
				...
				return o === a
					...
					: o > a
						...
						: o > 0 ? r.slice(0, o) + '.' + r.slice(o) : '0.' + new Array(1 - o).join('0') + Je(t, Math.max(0, n + o - 1))[0];
			},
			X: function(t){
		...
		gp = {
			...
			polygonEnd: function(){
				pp.polygonEnd(),
					...
					(gp.lineStart = Rr),
					(gp.lineEnd = Lr),
					hp < 0 ? ((yd = -(bd = 180)), (_d = -(md = 90))) : vp > Hd ? (md = 90) : vp < -Hd && (_d = -90),
					(Nd[0] = yd),
					(Nd[1] = bd);
			},
		},
				...
				return {
					...
					point: function(o, a){
						var u = o > 0 ? Gd : -Gd,
							f = Jd(o - e);
						Jd(f - Gd) < Hd
							? (t.point(e, (r = (r + a) / 2 > 0 ? Vd : -Vd)), t.point(i, r), t.lineEnd(), t.lineStart(), t.point(u, r), t.point(o, r), (n = 0))
							: i !== u &&
								f >= Gd &&
								(Jd(e - i) < Hd && (e -= i * Hd),
								Jd(o - u) < Hd && (o -= u * Hd),
			...
			insert: function(t, n){
				...
				for (n.L = n.R = null, n.U = e, n.C = !0, t = n; e && e.C; )
					e === (r = e.U).L
						? (i = r.R) && i.C
							? ((e.C = i.C = !1), (r.C = !0), (t = r))
							: (t === e.R && (mc(this, e), (e = (t = e).U)), (e.C = !1), (r.C = !0), xc(this, r))
						: (i = r.L) && i.C
							? ((e.C = i.C = !1), (r.C = !0), (t = r))
							: (t === e.L && (xc(this, e), (e = (t = e).U)), (e.C = !1), (r.C = !0), mc(this, r)),
						(e = t.U);
				this._.C = !1;
			},
			remove: function(t){
						...
						do {
							...
							if (t === i.L) {
								if (((n = i.R).C && ((n.C = !1), (i.C = !0), mc(this, i), (n = i.R)), (n.L && n.L.C) || (n.R && n.R.C))) {
									(n.R && n.R.C) || ((n.L.C = !1), (n.C = !0), xc(this, n), (n = i.R)),
										(n.C = i.C),
										(i.C = n.R.C = !1),
										mc(this, i),
										(t = this._);
								...
								(n.L && n.L.C) || ((n.R.C = !1), (n.C = !0), mc(this, n), (n = i.L)),
									(n.C = i.C),
									(i.C = n.L.C = !1),
									xc(this, i),
									(t = this._);
					...
					if ((o = (i = e.halfedges).length))
						for (var i, o, a, u = e.site, f = -1, c = n[i[o - 1]], s = c.left === u ? c.right : c.left; ++f < o; )
							(a = s),
								...
								a && s && r < a.index && r < s.index && Oc(u, a, s) < 0 && t.push([ u.data, a.data, s.data ]);
				}),
				t
			);
		},
	...
	(jc.prototype = Ic.prototype),
		...
		(t.thresholdFreedmanDiaconis = function(t, e, r){
			return (t = rs.call(t, i).sort(n)), Math.ceil((r - e) / (2 * (v(t, 0.75) - v(t, 0.25)) * Math.pow(t.length, -1 / 3)));
		}),
		...
		(t.ribbon = function(){
			function t(){
				...
				if (
					...
					a.moveTo(d, p),
					a.arc(0, 0, s, l, h),
					(l === g && h === y) || (a.quadraticCurveTo(0, 0, v * Th(g), v * Nh(g)), a.arc(0, 0, v, g, y)),
		...
		(t.contourDensity = function(){
			function t(t){
				...
				t.forEach(function(t, n, r){
					...
					Ae({width: v, height: y, data: e}, {width: v, height: y, data: r}, l >> h),
					Te({width: v, height: y, data: r}, {width: v, height: y, data: e}, l >> h),
					Ae({width: v, height: y, data: e}, {width: v, height: y, data: r}, l >> h),
					Te({width: v, height: y, data: r}, {width: v, height: y, data: e}, l >> h),
					Ae({width: v, height: y, data: e}, {width: v, height: y, data: r}, l >> h),
					Te({width: v, height: y, data: r}, {width: v, height: y, data: e}, l >> h);
		...
		(t.drag = function(){
			...
			function e(){
				if (!h && d.apply(this, arguments)) {
					...
					n &&
						(ct(t.event.view).on('mousemove.drag', r, !0).on('mouseup.drag', i, !0),
						_t(t.event.view),
						gt(),
						(l = !1),
						(c = t.event.clientX),
			...
			function f(e, r, i, o, a){
				var u,
					...
					l = _.copy();
				if (
					ot(new xt(n, 'beforestart', u, e, b, s[0], s[1], 0, 0, l), function(){
				...
				for (var e = 0, r = t.length; e < d; ++e)
					for (var i, u, f, s, l, h, p, v = 0; v < r; ++v)
						(u = (i = t[v]).source),
							...
							(s *= h = ((h = Math.sqrt(s * s + l * l)) - a[v]) / h * n * o[v]),
							(l *= h),
							(f.vx -= s * (p = c[v])),
							(f.vy -= l * p),
							(u.vx += s * (p = 1 - p)),
			...
			if (((md = bd = -(yd = _d = 1 / 0)), (Td = []), br(t, gp), (e = Td.length))) {
				for (Td.sort(Yr), n = 1, o = [ (r = Td[0]) ]; n < e; ++n)
					Br(r, (i = Td[n])[0]) || Br(r, i[1])
						? (Or(r[0], i[1]) > Or(r[0], r[1]) && (r[1] = i[1]), Or(i[0], r[1]) > Or(r[0], r[1]) && (r[0] = i[0]))
						: o.push((r = i));
				for (a = -1 / 0, n = 0, r = o[(e = o.length - 1)]; n <= e; r = i, ++n)
					(i = o[n]), (u = Or(r[1], i[0])) > a && ((a = u), (yd = i[0]), (bd = r[1]));
			}
		...
		(t.geoCentroid = function(t){
			...
			var n = Dd,
				...
				r = qd,
				i = n * n + e * e + r * r;
			return i < Xd && ((n = zd), (e = Rd), (r = Ld), Ed < Hd && ((n = kd), (e = Cd), (r = Pd)), (i = n * n + e * e + r * r) < Xd)
				? [ NaN, NaN ]
			...
			return (
				(t.invert = function(t){
					var n = f.scale(),
						...
						r = (t[0] - e[0]) / n,
						i = (t[1] - e[1]) / n;
					return (i >= 0.12 && i < 0.234 && r >= -0.425 && r < -0.214 ? c : i >= 0.166 && i < 0.234 && r >= -0.214 && r < -0.115 ? s : f).invert(t);
				}),
				(t.stream = function(t){
					return e && r === t
						? e
				...
				(t.scale = function(n){
					return arguments.length ? (f.scale(n), c.scale(0.35 * n), s.scale(n), t.translate(f.translate())) : f.scale();
				}),
				(t.translate = function(t){
					...
					var e = f.scale(),
						...
						u = +t[1];
					return (
						(i = f.translate(t).clipExtent([ [ r - 0.455 * e, u - 0.238 * e ], [ r + 0.455 * e, u + 0.238 * e ] ]).stream(l)),
						(o = c
							.translate([ r - 0.307 * e, u + 0.201 * e ])
							.clipExtent([ [ r - 0.425 * e + Hd, u + 0.12 * e + Hd ], [ r - 0.214 * e - Hd, u + 0.234 * e - Hd ] ])
							.stream(l)),
						(a = s
							.translate([ r - 0.205 * e, u + 0.212 * e ])
							.clipExtent([ [ r - 0.214 * e + Hd, u + 0.166 * e + Hd ], [ r - 0.115 * e - Hd, u + 0.234 * e - Hd ] ])
							.stream(l)),
						n()
					);
				}),
		...
		(t.geoIdentity = function(){
			...
			return (a = {
				...
				clipExtent: function(i){
					return arguments.length
						? ((p = null == i ? ((d = n = e = r = null), zi) : yi((d = +i[0][0]), (n = +i[0][1]), (e = +i[1][0]), (r = +i[1][1]))), t())
						: null == d ? null : [ [ d, n ], [ e, r ] ];
				},
				scale: function(n){
			...
			function t(t){
				return (
					...
					n
						...
						: t.eachBefore(Qo(Zo)).eachAfter(Jo($o, 1)).eachAfter(Jo(i, t.r / Math.min(e, r))).eachBefore(Ko(Math.min(e, r) / (2 * t.r))),
					t
				);
			}
			var n = null,
		...
		(t.stratify = function(){
			function t(t){
				var r,
					...
					h = {};
				for (i = 0; i < s; ++i)
					(r = t[i]), (u = l[i] = new Do(r)), null != (f = n(r, i, t)) && (f += '') && (h[(c = gv + (u.id = f))] = c in h ? _v : u);
				for (i = 0; i < s; ++i)
				...
				t.parent.A = (function(t, n, e){
					if (n) {
						for (var r, o = t, a = t, u = n, f = o.parent.children[0], c = o.m, s = a.m, l = u.m, h = f.m; (u = aa(u)), (o = oa(o)), u && o; )
							(f = oa(f)),
								((a = aa(a)).a = t),
								(r = u.z + l - o.z - c + i(u._, o._)) > 0 && (ua(fa(u, t, e), t, r), (c += r), (s += r)),
								(l += u.m),
								(c += o.m),
								(h += f.m),
								(s += a.m);
		...
		(t.interpolateRainbow = function(t){
			...
			return (f_.h = 360 * t - 100), (f_.s = 1.5 - 1.5 * n), (f_.l = 0.8 - 0.9 * n), f_ + '';
		}),
		...
		(t.arc = function(){
			function t(){
				...
				if ((f || (f = t = oe()), l < s && ((c = l), (l = s), (s = c)), l > M_))
					if (p > N_ - M_)
						f.moveTo(l * __(h), l * x_(h)), f.arc(0, 0, l, h, d, !v), s > M_ && (f.moveTo(s * __(d), s * x_(d)), f.arc(0, 0, s, d, h, v));
					else {
						var g,
							y,
							_ = h,
						...
						if (T > M_) {
							var k = hf(T / s * x_(A)),
								C = hf(T / l * x_(A));
							(w -= 2 * k) > M_ ? ((k *= v ? 1 : -1), (m += k), (x -= k)) : ((w = 0), (m = x = (h + d) / 2)),
								(M -= 2 * C) > M_ ? ((C *= v ? 1 : -1), (_ += C), (b -= C)) : ((M = 0), (_ = b = (h + d) / 2));
						}
						var P = l * __(_),
							z = l * x_(_),
							R = s * __(x),
						...
						M > M_
							? E > M_
								? ((g = _f(q, O, P, z, l, E, v)),
									...
									E < N
										? f.arc(g.cx, g.cy, E, y_(g.y01, g.x01), y_(y.y01, y.x01), !v)
										: (f.arc(g.cx, g.cy, E, y_(g.y01, g.x01), y_(g.y11, g.x11), !v),
											f.arc(0, 0, l, y_(g.cy + g.y11, g.cx + g.x11), y_(y.cy + y.y11, y.cx + y.x11), !v),
											f.arc(y.cx, y.cy, E, y_(y.y11, y.x11), y_(y.y01, y.x01), !v)))
							...
							s > M_ && w > M_
								? S > M_
									? ((g = _f(R, L, D, U, s, -S, v)),
										...
										S < N
											? f.arc(g.cx, g.cy, S, y_(g.y01, g.x01), y_(y.y01, y.x01), !v)
											: (f.arc(g.cx, g.cy, S, y_(g.y01, g.x01), y_(g.y11, g.x11), !v),
												f.arc(0, 0, s, y_(g.cy + g.y11, g.cx + g.x11), y_(y.cy + y.y11, y.cx + y.x11), v),
												f.arc(y.cx, y.cy, S, y_(y.y11, y.x11), y_(y.y01, y.x01), !v)))
									: f.arc(0, 0, s, x, m, v)
								: f.lineTo(R, L);
					}
				else f.moveTo(0, 0);
		...
		(t.voronoi = function(){
			...
			return (
				...
				(t.extent = function(n){
					return arguments.length
						? ((r = null == n ? null : [ [ +n[0][0], +n[0][1] ], [ +n[1][0], +n[1][1] ] ]), t)
			...
			function l(){
				if (g.apply(this, arguments)) {
					var n,
						...
						f = u.length;
					for (Hc(), e = 0; e < f; ++e)
						(i = [ (i = vt(this, u, (r = u[e]).identifier)), this.__zoom.invert(i), r.identifier ]),
			...
			function h(){
				...
				for (Xc(), p && (p = clearTimeout(p)), n = 0; n < s; ++n)
					(o = vt(this, c, (i = c[n]).identifier)),
						f.touch0 && f.touch0[2] === i.identifier ? (f.touch0[0] = o) : f.touch1 && f.touch1[2] === i.identifier && (f.touch1[0] = o);
					...
					n.transform(t, function(){
						...
						return _(
							fb
								.translate(o[0], o[1])
								.scale(n.k)
								.translate('function' == typeof e ? -e.apply(this, arguments) : -e, 'function' == typeof r ? -r.apply(this, arguments) : -r),
							t,
							w
						);
					});
